...
const steps = [
  ...
  },
  {
    ...
    bubblePositions: [
      ...
      { top: '35%', left: '45%' },      // Center middle
      { bottom: 0, right: '35%' },      // Cut off at bottom
      { top: '10%', right: '25%' },     // Upper right
      { top: '65%', left: '15%' },      // Lower left
      { top: '3%', left: -20 }          // Cut off at bottom-left
    ]
  },
  {
    title: "Connect & Care",
    ...
    bubblePositions: [
      ...
      { bottom: 5, left: '25%' },       // Cut off at bottom
      { top: '45%', left: -25 },        // Cut off at left middle
      { top: '10%', right: '30%' },     // Upper right
      { bottom: 2, right: -15 }         // Cut off at bottom-right
    ]
  }
];
...
const styles = StyleSheet.create({
  ...
  // Added gray overlay style
  grayOverlay: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: 'rgba(142, 145, 150, 0.4)', // Using neutral gray with 40% opacity
    borderRadius: 999,
    zIndex: 2,
  },
  foodImage: {
  ...
  logoContainer: {
    ...
    alignSelf: 'center',
    top: '40%',
    width: SCREEN_WIDTH * 0.44, // Increased by 10% from original 0.4
    height: SCREEN_WIDTH * 0.44, // Increased by 10% from original 0.4
    justifyContent: 'center',
    alignItems: 'center',
  },
  logo: {
